...
public class SignatoryModel {
    ...
    /**
     * @return the meansofidentification
     */
    ...
    /**
     * @param meansofidentification the meansofidentification to set
     */
    ...
    /**
     * @return the idissuerdate
     */
    public String getIdissuerdate() {
        return idissuerdate;
    }

    /**
     * @param idissuerdate the idissuerdate to set
     */
    public void setIdissuerdate(String idissuerdate) {
        this.idissuerdate = idissuerdate;
    }
    ...
    /**
     * @param countryofResidency the countryofResidency to set
     */
