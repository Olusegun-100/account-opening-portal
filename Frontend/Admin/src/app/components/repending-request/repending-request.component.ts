...
@Component({
  selector: 'app-repending-request',
  templateUrl: './repending-request.component.html',
  styleUrls: ['./repending-request.component.css']
})
export class RependingRequestComponent {
  ...
  view () {
    let data: any = {
      status: (this.rolename == 'initiator') ? "initiator-repending" : (this.rolename == 'approver') ? "repending" : 'N/A',
      staffId:this.staffId 
    };
    console.log(data);
  ...
  viewMore(data: any) {
    ...
    this.router.navigate(['/repending-requestdetails']);
