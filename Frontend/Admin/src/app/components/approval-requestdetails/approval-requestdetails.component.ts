...
@Component({
  selector: 'app-approval-requestdetails',
  templateUrl: './approval-requestdetails.component.html',
  styleUrls: ['./approval-requestdetails.component.css']
})
export class ApprovalRequestdetailsComponent {
