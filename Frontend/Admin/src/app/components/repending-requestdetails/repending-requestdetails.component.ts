...
@Component({
  selector: 'app-repending-requestdetails',
  templateUrl: './repending-requestdetails.component.html',
  styleUrls: ['./repending-requestdetails.component.css']
})
export class RependingRequestdetailsComponent {
